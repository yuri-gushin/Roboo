...
It uses a positive security model where all allowed robotic activity must be whitelisted, any all other clients
are verified (using the challenge/response mechanisms) prior to their proxying to the protected endpoint.
...
============================
Copy Roboo.pm and configure Nginx as per the provided example configuration file.
